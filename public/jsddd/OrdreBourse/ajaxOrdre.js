var ajax_ordre = {
    ...
    RecuperationListeTitre: function () {
        ...
        var ttcs = document.getElementById('boursebundle_changementcompartiment_typeTitre');
        if (ttcs != null && typeTitre==null) {
            var typeTitre = $('#boursebundle_changementcompartiment_typeTitre').val();
        }
        var dn_tt = document.getElementById('nantissementbundle_demandenantissement_typeTitre');
        if (dn_tt != null && typeTitre==null) {
            var typeTitre = $('#nantissementbundle_demandenantissement_typeTitre').val();
        }
        //var typeTitre = document.getElementById('typeTitre_chosen');
        if (typeTitre != null && typeTitre==null) {
            var typeTitre = $('#typeTitre_chosen').val();
        }
        //var typeTitre = document.getElementById('typeTitre');
        if (typeTitre != null && typeTitre==null) {
            var typeTitre = $('#typeTitre').val();
        }
        console.log(typeTitre);
        if(typeTitre!=null && typeTitre!='') {
            console.log(typeTitre, ttcs);
            $('#loader').show();
            $('#symbol').empty();
            $('#symbol').append();
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data!=null && data!='' && data.length>0) {
                        ...
                        // var symcs = document.getElementById('boursebundle_changementcompartiment_symbol');
                        // if (symcs != null) {
                        //         $('#boursebundle_changementcompartiment_symbol').empty();
                        //         $('#boursebundle_changementcompartiment_symbol').append(newOption);
                        //         $('#boursebundle_changementcompartiment_symbol').trigger("chosen:updated");
                        //         $('#boursebundle_changementcompartiment_symbol').trigger("change");
                        // }
                    }
                    $('#loader').hide();
                },
            ...
            var msg = 'Veuillez choisir le type de titre';
            alert(msg);
        }
    },
    RecuperationInformationTitre: function () {
       ...
       // alert(titre);
        ...
        var symcs = document.getElementById('boursebundle_changementcompartiment_typeTitre');
        if (symcs != null && typeTitre==null) {
            var typeTitre = $('#boursebundle_changementcompartiment_typeTitre').val();
            var titre = $('#symbol').val();
        }
        var dn_tt = document.getElementById('nantissementbundle_demandenantissement_typeTitre');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data != null || data != '') {
                    ...
                    // ret=data;
                    var coursReel = ret.coursreel;
                    var retour = ret.infoTitre;
                    ...
                    console.log(data,coursReel,retour);
                    console.log(retour.symboldefauttitre, retour.designationtitre,marge,coursInf,coursSup);
                    ...
                    var depos_nantissement = document.getElementById('nantissementbundle_demandenantissement_sigleDepositaire');
                    if (depos_nantissement != null) {
                        if (retour.sigledepositaire != null || retour.sigledepositaire != '')
                            $('#nantissementbundle_demandenantissement_sigleDepositaire').val(retour.sigledepositaire);
                    }
                    ...
                    // }
                    var anciennneCotation = document.getElementById('boursebundle_changementcompartiment_ancienneCotation');
                    if (anciennneCotation != null) {
                        if (retour.libellecotation != null || retour.libellecotation != '')
                            $('#boursebundle_changementcompartiment_ancienneCotation').val(retour.libellecotation);
                    }
                }
                $('#loader').hide();
                $('#orderform').hide();
